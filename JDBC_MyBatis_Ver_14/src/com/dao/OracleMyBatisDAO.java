...
//		return new_list;
	...
	public List<Dept> selectTopN(SqlSession session, String string, int offset, int limit) {
		// TODO Auto-generated method stub
		List<Dept> list = session.selectList("topNloc", string, new RowBounds(offset, limit));
